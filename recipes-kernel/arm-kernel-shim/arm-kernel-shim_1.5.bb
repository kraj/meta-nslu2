...
do_install() {
	install -d ${D}/loader
	cp ${S}/arm-kernel-shim-nslu2.bin ${D}/loader
	cp ${S}/arm-kernel-shim-nas100d.bin ${D}/loader
	cp ${S}/arm-kernel-shim-dsmg600.bin ${D}/loader
	cp ${S}/arm-kernel-shim-fsg3.bin ${D}/loader
}
